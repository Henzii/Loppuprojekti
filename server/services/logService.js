...
var writeLog = function (process, type, message) {
    (0, mySqlHelpers_1.makeConnection)().then(function (con) {
        con.query('INSERT into logs (process, type, message) VALUES (?)', [[process, type, message]])
            .catch(function (e) { return console.log('Virhe lokin kirjoittamisessa', e.message); });
    }).catch(function (e) { return console.log('Loki ei saa yhteyttä databaseen', e.message); });
};
var readLogs = function (process) { return __awaiter(void 0, void 0, void 0, function () {
    var con, rows;
